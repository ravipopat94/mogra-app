  ...
  return (
    <header className="sticky top-0 z-50 bg-background border-b border-brand-border">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4">
        ...
        {/* Cart icon — hidden on mobile (shown in MobileCartBar instead) */}
        <Link href="/cart" aria-label="View cart" className="relative flex-shrink-0 hidden md:flex text-foreground hover:text-gold transition-colors">
